...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _configureStore2.default)(initialState, _api2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _makeStateWithLocation = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _container3 = __webpack_require__(256);

	var _container4 = _interopRequireDefault(_container3);

	var _container5 = __webpack_require__(260);

	var _container6 = _interopRequireDefault(_container5);

	var _container7 = __webpack_require__(265);

	var _container8 = _interopRequireDefault(_container7);

	var _container9 = __webpack_require__(268);
	...
	exports.default = _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/blog', component: _container4.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/galleries', component: _container6.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/', component: _container10.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '*', component: _container8.default })
	);
	    ...
	    _createClass(AppContainer, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            if (nextProps.location.pathname !== this.props.location.pathname) {
	                this.props.dispatch((0, _actions.clearXhrError)());
	            }
	        }
	    }, {
	        key: 'feetchIfNeeded',
	        value: function feetchIfNeeded(nextProps) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(_App2.default, _extends({}, this.props.app, { children: this.props.children }));
	        }
	    }], [{
	        key: 'fetch',
	        value: function fetch(_ref) {
	            ...
	            dispatch((0, _actions.fetchAppData)());
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var clearXhrError = exports.clearXhrError = function clearXhrError() {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function App(_ref) {
	    ...
	    var xhrPending = _ref.xhrPending;
	    var xhrError = _ref.xhrError;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'header',
	            null,
	            _react2.default.createElement(_Menu2.default, { items: menu })
	        ),
	        xhrPending ? _react2.default.createElement(
	            'div',
	            null,
	            'Loading...'
	        ) : null,
	        xhrError ? _react2.default.createElement(
	            'div',
	            null,
	            'All is lost!'
	        ) : children,
	...
	var Menu = function Menu(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        items.map(function (item) {
	            return _react2.default.createElement(
	                'li',
	                { key: item.link, className: 'main-menu__item' },
	                _react2.default.createElement(
	                    _reactRouter.Link,
	                    { to: item.link },
	                    item.title
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BlogList = __webpack_require__(257);
	...
	var BlogContainer = function (_React$Component) {
	    ...
	    function BlogContainer() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(BlogContainer).apply(this, arguments));
	    }
	    ...
	    _createClass(BlogContainer, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(_BlogList2.default, { blog: this.props.blog });
	        }
	    }], [{
	        key: 'fetch',
	        value: function fetch(_ref) {
	            ...
	            return dispatch((0, _actions.fetchBlogData)());
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BlogItem = __webpack_require__(258);
	...
	var BlogList = function BlogList(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        blog.map(function (item) {
	            return _react2.default.createElement(_BlogItem2.default, { key: item.id, item: item });
	        })
	    );
	};
...
/***/ function(module, exports) {
	...
	var fetchBlogData = exports.fetchBlogData = function fetchBlogData() {
	    return {
	        type: 'DATA_PLEASE',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GalleriesList = __webpack_require__(261);

	var _GalleriesList2 = _interopRequireDefault(_GalleriesList);
	...
	var GalleriesContainer = function (_React$Component) {
	    _inherits(GalleriesContainer, _React$Component);

	    function GalleriesContainer() {
	        _classCallCheck(this, GalleriesContainer);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(GalleriesContainer).apply(this, arguments));
	    }

	    _createClass(GalleriesContainer, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            this.feetchIfNeeded(this.props);
	        }
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(_GalleriesList2.default, { galleries: this.props.galleries });
	        }
	    }], [{
	        key: 'fetch',
	        value: function fetch(_ref) {
	            ...
	            return dispatch((0, _actions.fetchGalleriesData)());
	        }
	    }]);

	    return GalleriesContainer;
	}(_react2.default.Component);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(GalleriesContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Gallery = __webpack_require__(262);

	var _Gallery2 = _interopRequireDefault(_Gallery);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GalleriesList = function GalleriesList(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        galleries.map(function (item) {
	            return _react2.default.createElement(_Gallery2.default, { key: item.id, gallery: item });
	        })
	    );
	};

	exports.default = GalleriesList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Image = __webpack_require__(263);
	...
	var Gallery = function Gallery(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        gallery.images.map(function (item) {
	            return _react2.default.createElement(_Image2.default, { key: item.id, image: item });
	        })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = function Image(_ref) {
	    ...
	    return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('img', { src: image.src + '?' + Math.random(), alt: image.caption }),
	        _react2.default.createElement(
	            'p',
	            null,
	            image.caption
...
/***/ function(module, exports) {
	...
	var fetchGalleriesData = exports.fetchGalleriesData = function fetchGalleriesData() {
	    return {
	        type: 'DATA_PLEASE',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageContainer = function (_React$Component) {
	    ...
	    _createClass(PageContainer, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(_Page2.default, { page: this.props.page });
	        }
	    }], [{
	        key: 'fetch',
	        value: function fetch(_ref) {
	            ...
	            return dispatch((0, _actions.fetchPageData)(splat));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDangerousHtml = function getDangerousHtml(html) {
	    return { __html: html };
	};
	...
	var Page = function Page(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { dangerouslySetInnerHTML: getDangerousHtml(page.content) })
	    );
	};
...
/***/ function(module, exports) {
	...
	var fetchPageData = exports.fetchPageData = function fetchPageData(splat) {
	    return {
	        type: 'DATA_PLEASE',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexContainer = function (_React$Component) {
	    _inherits(IndexContainer, _React$Component);

	    function IndexContainer() {
	        _classCallCheck(this, IndexContainer);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(IndexContainer).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (endpoint) {
	    ...
	    var url = '/api/' + endpoint + '?' + Object.keys(data).map(function (k) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataMiddleware = __webpack_require__(285);

	var _dataMiddleware2 = _interopRequireDefault(_dataMiddleware);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function configureStore(initialState, api) {
	    var middleware = [(0, _reactRouterRedux.routerMiddleware)(_reactRouter.browserHistory), (0, _dataMiddleware2.default)(api)];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sync = __webpack_require__(277);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer3 = __webpack_require__(281);

	var _reducer4 = _interopRequireDefault(_reducer3);

	var _reducer5 = __webpack_require__(282);

	var _reducer6 = _interopRequireDefault(_reducer5);

	var _reducer7 = __webpack_require__(283);

	var _reducer8 = _interopRequireDefault(_reducer7);

	var _reducer9 = __webpack_require__(284);
	...
	var reducer = (0, _redux.combineReducers)({
	    ...
	    blog: _reducer4.default,
	    galleries: _reducer6.default,
	    index: _reducer8.default,
	    page: _reducer10.default,
...
/***/ function(module, exports) {
	...
	function app() {
	    ...
	    switch (action.type) {
	        ...
	        case 'XHR_STARTED':
	            newState = _extends({}, state, { xhrPending: true, xhrError: false });
	            break;

	        case 'XHR_SUCCEEDED':
	            newState = _extends({}, state, { xhrPending: false, xhrError: false });
	            break;

	        case 'XHR_FAILED':
	            newState = _extends({}, state, { xhrPending: false, xhrError: true });
	            break;

	        case 'CLEAR_XHR_ERROR':
	            newState = _extends({}, state, { xhrError: false });
	            break;
	    ...
	    return function (store) {
	        return function (next) {
	            return function (action) {
	                ...
	                return api(action.key, action.payload || {}).then(function (data) {
